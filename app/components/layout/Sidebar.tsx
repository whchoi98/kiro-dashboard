  ...
  return (
    <aside className="fixed top-0 left-0 h-screen w-[220px] bg-dashboard-sidebar flex flex-col z-30 border-r border-gray-800/50">
      ...
      <div className="px-3 pb-1">
        <a
          href="/auth/logout"
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-slate-400 hover:text-red-400 hover:bg-gray-800/50 transition-all duration-150"
        >
