...
const translations: Record<Locale, Record<string, string>> = {
  ko: {
    ...
    'analyze.example2': '가장 활발한 사용자 TOP 5 분석',
    'analyze.example3': 'IDE 생산성 메트릭 요약',
    'analyze.example4': '클라이언트 타입별 사용 비교',
  },
  en: {
    ...
    'analyze.example2': 'Top 5 most active users analysis',
    'analyze.example3': 'IDE productivity metrics summary',
    'analyze.example4': 'Client type usage comparison (IDE vs CLI)',
  },
};
